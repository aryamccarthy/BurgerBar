...
CREATE TABLE IF NOT EXISTS `BurgerBar`.`Order` (
  ...
  PRIMARY KEY (`idOrder`, `email`),
  INDEX `fk_Order_User1_idx` (`email` ASC),
...
CREATE TABLE IF NOT EXISTS `BurgerBar`.`Order_has_OrderBurger` (
  ...
  PRIMARY KEY (`idOrder`, `idOrderBurger`),
  INDEX `fk_Order_has_OrderBurger_OrderBurger1_idx` (`idOrderBurger` ASC),
  INDEX `fk_Order_has_OrderBurger_Order1_idx` (`idOrder` ASC),
